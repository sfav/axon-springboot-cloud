...
/**
 * <p>Create a new customer by proving the details information available 
 * for the customer. You also must provide the id of the user that wants to create the customer.</p>
 *
 * @author Thomas Yuan
 */
...
public class CreateCustomerCommand {
	...
	public CreateCustomerCommand(CustomerId customerId, String passwordHash, String nickName,
